...
# 
# Since: January, 2017
# Author: Christian Marquardt <christian@marquardt.sc>
# Description: Creates an Oracle Database based on following parameters:
#              $ORACLE_SID: Oracle SID and CDB name (default: ORCLCDB)
#              $ORACLE_PDB: PDB name (default: ORCLPDB1)
#              $ORACLE_PWD: Password for SYS, SYSTEM and PDBADMIN (default: random hash)
# 
# This script is based on runOracle.sh by Gerald Venzl.
